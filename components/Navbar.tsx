    ...
    <nav className="absolute top-0 left-0 z-20 w-full">
      <div className=" w-full flex items-center justify-between px-4 py-5 sm:px-6 sm:py-6 md:px-8 md:py-8 lg:px-16 lg:py-12 ">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <p className=" text-white text-[11px] sm:text-[13px] md:text-[15px] lg:text-lg font-bold leading-[1.1] whitespace-nowrap ">
            TI SCHOOL
            <br />
            TURF
          </p>
        ...
        <div className=" flex items-center gap-1.5 sm:gap-2 md:gap-2.5 lg:gap-3 ">
          ...
          >
            <span className=" hidden min-[400px]:block text-black text-[10px] sm:text-xs md:text-sm font-semibold whitespace-nowrap ">
              Get the App
            </span>
